...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.setGraphicSize(Std.int(logoBl.width * 0.5125));
		...
		if(!FlxG.save.data.psykaEasterEgg || !easterEggEnabled) {
			...
			gfDance.getPosition();
			gfDance.setPosition(50, 0);
			gfDance.frames = Paths.getSparrowAtlas('gfDanceTitle');
			gfDance.animation.addByPrefix('GF Dancing Beat instance', 'GF Dancing Beat instance',  24, false);
			gfDance.animation.addByPrefix('GF Dancing Beat instance', 'GF Dancing Beat instance', 24, false);
		}
	...
	override function beatHit()
	{
		...
		if(gfDance != null) {
			...
			if (danceLeft)
				gfDance.animation.play('GF Dancing Beat instance');
			else
				gfDance.animation.play('GF Dancing Beat instance');
		}
